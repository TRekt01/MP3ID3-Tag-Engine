<?php
/**
*Element decorator for renaming tracks (adds an .mp3) after the element
*
...
*/
class Form_Decorator_trackRenameElementDecorator extends Zend_Form_Decorator_Abstract
{
         /**
         ...
         */
         public function render($content)
         {
                 ...
                 if($label != ""){
                         $output = "<td>".$label."</td><td>".$input.".mp3</td>";
                 }else{
                         $output = "<td>".$input.".mp3</td>";
                 }
                 return $output;
         }
}
