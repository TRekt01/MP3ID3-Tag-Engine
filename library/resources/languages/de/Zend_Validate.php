...
return array(
    ...
    "An exception has been raised while validating '%value%'" => "Eine Exception wurde während der Prüfung von '%value%' geworfen",
    ...
    "Invalid type given. String expected" => "Ungültiger Typ angegeben. String erwartet",
    "'%value%' is no valid email address in the basic format local-part@hostname" => "Die von Ihnen eingegebene E-Mail-Adresse '%value%' entspricht keiner güligen Form (alice@bob.de). Bitte überprüfen Sie Ihre Eingabe.",
    "'%hostname%' is no valid hostname for email address '%value%'" => "'%hostname%' ist kein gültiger Hostname für die Emailadresse '%value%'",
    "'%hostname%' does not appear to have a valid MX record for the email address '%value%'" => "Die von Ihnen eingegebene E-Mail-Adresse '%value%' entspricht keiner güligen Form (alice@bob.de). Bitte überprüfen Sie Ihre Eingabe.",
    "'%hostname%' is not in a routable network segment. The email address '%value%' should not be resolved from public network" => "Die von Ihnen eingegebene E-Mail-Adresse '%value%' entspricht keiner güligen Form (alice@bob.de). Bitte überprüfen Sie Ihre Eingabe.",
    ...
    "'%localPart%' is no valid local part for email address '%value%'" => "Die von Ihnen eingegebene E-Mail-Adresse '%value%' entspricht keiner güligen Form (alice@bob.de). Bitte überprüfen Sie Ihre Eingabe.",
    ...
    "Maximum allowed size for file '%value%' is '%max%' but '%size%' detected" => "Die maximal erlaubte Geöße für die Datei '%value%' ist '%max%', aber es wurde '%size%' entdeckt",
    ...
    "'%value%' is not greater than '%min%'" => "'%value%' ist nicht gröÃŸer als '%min%'",
    ...
    "Invalid type given. String expected" => "Ungültiger Typ angegeben. String erwartet",
    "'%value%' appears to be an IP address, but IP addresses are not allowed" => "Es scheint als wäre '%value%' kein valider Hostname (keine IP-Unterstützung). Bitte überprüfen Sie Ihre Eingabe.",
    ...
    "'%value%' appears to be a local network name but local network names are not allowed" => "Es scheint, als wäre '%value%' kein valider Hostname (keine Unterstützung lokaler Netwerke). Bitte überprüfen Sie Ihre Eingabe.",
